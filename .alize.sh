...
alias goi='go mod init ${PWD##*/} && wget https://gitee.com/AlmondLee/simple_mirror/raw/master/.gitignore && git init && git add -A &&git commit --gpg-sign -m init && git checkout -b dev1 && git status'
# alias goi='go mod init this-project && wget https://gitee.com/AlmondLee/simple_mirror/raw/master/.gitignore && git init && git add -A &&git commit --gpg-sign -m init && git checkout -b dev1 && git status'
